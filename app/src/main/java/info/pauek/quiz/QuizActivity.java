...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        Log.i("lifecycle", "onStart"); //Mensaje para ver qué ocurre con la app
        super.onStart();
    }
    ...
    @Override
        protected void onCreate(Bundle savedInstanceState) { //guardamos all lo que nos gustaría guardar
    ...
    private void checkResults() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this); //Objeto builder, nos construye el cuadro de diálogo
        builder.setTitle(R.string.results); //Título
        builder.setMessage(message); //Mensaje
        builder.setCancelable(false); //Una vez sale el cuadro de diálogo no podemos ir para atrás
        builder.setPositiveButton(R.string.finish, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                finish(); //método que cierra la actividad
            }
        });
